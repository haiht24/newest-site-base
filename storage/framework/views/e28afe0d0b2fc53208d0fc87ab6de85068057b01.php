<?php $__env->startSection('cssDevMod'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/css/category.min.css')); ?>" media="all,handheld"/>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('cssMix'); ?>
    ##parent-placeholder-e9e218ca08909ddb807d504b19b6ff12cdcbede5##
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset(mix('/css/mix-category.css'))); ?>" media="all,handheld"/>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('head'); ?>
##parent-placeholder-1a954628a960aaef81d7b2d4521929579f3541e6##
<link rel="canonical" href="<?php echo e(route('cat-detail', ['alias'=>$cat->alias])); ?>">
<?php $__env->stopSection(); ?>
            ...
            <div class="wrap-cat-i">
                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cat-show-i">
                        <a href="<?php echo e(url('/category/'.$c->alias)); ?>" title="<?php echo e($c->name); ?> category detail show all stores deals, coupons">
                            <i class="c-i <?php echo e($c->icon); ?>">
    ...
    <div class="cat-content">
        <div class="cat-box-item">
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo e(url('/category')); ?>">All Categories</a></li>
                <li class="active"><?php echo e($cat->name); ?></li>
            </ul>

            <div class="cat-item-title">
                <div>
                    <strong title="<?php echo e($cat->name); ?> categories">
                    <h3 class="c-title"><i class="<?php echo e($cat->icon); ?>"></i> <?php echo e($cat->name); ?></h3>
                    </strong>
                </div>
            </div>
            ...
            <div class="clear"></div>
            <div class="cat-show-more btn btn-default" id="show-more" data-url="<?php echo e(url('/category/'.$cat->alias)); ?>">
...
<?php $__env->startSection('scriptDevMod'); ?>
    ...
    <script src="<?php echo e(asset('/js/modules/category/index.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('scriptMix'); ?>
    ##parent-placeholder-ca032044983c896280b5db2c4a245dd6b895d7bb##
    <script src="<?php echo e(asset(mix('/js/mix-category.js'))); ?>"></script>
<?php $__env->stopSection(); ?>
